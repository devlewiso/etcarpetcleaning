  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gray-100 text-gray-900">
      <div className="w-full bg-white p-10 rounded-lg shadow-2xl">
        {/* Page Heading */}
        <h1 className="text-5xl font-bold mb-6 text-purple-800 text-center">Contact Us</h1>
        ...
        <div className="mb-12">
          <div className="text-center mb-6">
            ...
            <div>
              <p className="text-xl font-bold mb-1 text-purple-800">Phone Number:</p>
          ...
          <div className="text-center mb-6">
            ...
            <div>
              <p className="text-xl font-bold mb-1 text-purple-800">Email:</p>
              <button className="text-lg text-blue-500 hover:text-blue-700 hover:underline">
          ...
          <div className="text-center mb-6">
            <p className="text-xl font-bold mb-1 text-purple-800">Address:</p>
            <p className="text-lg mb-4">San Luis Obispo, CA</p>
          </div>
          <div className="text-center">
            <p className="text-xl font-bold mb-1 text-purple-800">Hours of Operation:</p>
        ...
        <div className="flex justify-center space-x-6 mb-12">
          ...
          <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-800">
            <FaYoutube className="text-3xl" />
          </a>
          <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            ...
            />
            <h3 className="text-2xl font-semibold mb-2 text-purple-800">Our Cleaning Process</h3>
            <p>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <Image
              ...
              className="rounded-lg mb-4 hover:scale-105 transition-transform duration-300"
            />
            <h3 className="text-2xl font-semibold mb-2 text-purple-800">Cleaning Tips & Tricks</h3>
            <p>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <Image
              ...
              className="rounded-lg mb-4 hover:scale-105 transition-transform duration-300"
            />
            <h3 className="text-2xl font-semibold mb-2 text-purple-800">Customer Testimonials</h3>
            <p>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <Image
              src="/images/frequently-asked-questions.jpg"
              alt="FAQs"
              width={600}
              height={400}
              className="rounded-lg mb-4 hover:scale-105 transition-transform duration-300"
            />
            <h3 className="text-2xl font-semibold mb-2 text-purple-800">Frequently Asked Questions</h3>
            <p>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <Image
              src="/images/carpet-stain-removal.jpg"
              alt="Carpet Stain Removal"
              width={600}
              height={400}
              className="rounded-lg mb-4 hover:scale-105 transition-transform duration-300"
            />
            <h3 className="text-2xl font-semibold mb-2 text-purple-800">Carpet Stain Removal</h3>
            <p>
