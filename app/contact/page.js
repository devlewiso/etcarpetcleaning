  ...
  <div className="text-center">
    ...
    <p className="text-lg mb-4">Monday - Sunday: 9:00 AM - 6:00 PM</p>
        ...
        <div className="flex justify-center space-x-6 mb-12">
          <a href="https://www.facebook.com/etsteamcarpetcleaning" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-500">
            <FaFacebookF className="text-3xl" />
          </a>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-500">
            <FaInstagram className="text-3xl" />
          </a>
          <a href="https://www.youtube.com/@e.t.carpetcleaning" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-500">
            <FaYoutube className="text-3xl" />
          </a>
          <a href="https://www.tiktok.com/@e.t.carpetcleaning" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-500">
            <FaTiktok className="text-3xl" />
          </a>
          <a href="https://x.com/EtCarpetSteam" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-500">
